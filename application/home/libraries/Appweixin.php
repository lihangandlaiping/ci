...
class Appweixin
{
    ...
    private $appsecret='';
    private $config='';
    function __construct($private_key,$appid,$mch_id,$appsecret,$weixin)
    {
    ...
    {
        require_once 'weixin/lib/Unifiedorder.php';
        $conf=array(
            'appid'=>$this->appid,
            'mch_id'=>$this->mch_id,
    ...
    function getWxNativePay($order_sn,$total_fee,$notify_url,$body)
    {
        ...
        if($request['code']==1)
        {
            ...
            require_once 'weixin/lib/phpqrcode.php';
            $url = urldecode($url);
            QRcode::png($url);
        }
        echo 'error';
     ...
     * 刷卡支付
     */
public function swipingCard($auth_code,$money,$notify_url)
{
    $GLOBALS['appId']=$this->config['g_appid']?:'wx426b3015555a46be';
    $GLOBALS['mchId']=$this->config['g_mch_id']?:'1900009851';
    $GLOBALS['private_key']=$this->config['g_private_key']?:'8934e7d15453e97507ef794cf7b0519d';
    $GLOBALS['notify_url']=$notify_url;
    $money=$money*100;
    require_once "weixin/lib/WxPay.Api.php";
    require_once "weixin/lib/WxPay.MicroPay.php";
    ...
    public function html5Pay($order_sn,$total_fee,$notify_url,$body)
    {
        require_once 'weixin/lib/Unifiedorder.php';
        $conf=array(
            'appid'=>$this->config['g_appid'],
            'mch_id'=>$this->config['g_mch_id'],
            'notify_url'=>$notify_url,
...
if (typeof WeixinJSBridge == "undefined"){
   ...
   onBridgeReady();
    ...
    function webpay($notify_url,$order_sn,$total_fee,$body)
    {
        require_once 'weixin/lib/Unifiedorder.php';
        $conf=array(
            'appid'=>$this->appid,
