                ...
                <div class="timeline-item">
                    <div class="row">
                        ...
                        <div class="col-xs-7 content">
                            <p class="m-b-xs"><strong>数据库备份<?php echo $row;?></strong>
                            </p>
                            <p> <?php echo $bz[$row];?></p>
                            <a href="<?php echo site_url('downloaddatabase',array('name'=>$row));?>" class="btn btn-success btn-rounded">下载
                                        </a>
                            <a href="javascript:void(0);" onclick="restore('<?php echo $row;?>')" class="btn btn-warning btn-rounded">还原
                            </a>
<a href="javascript:void(0);" onclick="sendGetAjax('<?php echo site_url('deletedatabase',array('name'=>$row));?>')" class="btn btn-danger btn-rounded">删除
                                        </a>
    ...
    <script>
        ...
        {
            var url='<?php echo site_url('restore');?>?name='+name;
            closemodal('myModal5');
            showlogdel(url);
        }
