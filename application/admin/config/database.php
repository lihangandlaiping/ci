...
$active_record = TRUE;
//第一套数据库连接
$db['default']['hostname'] = '192.168.7.100';
$db['default']['username'] = 'root';
$db['default']['password'] = 'yanyu20162017@#';
$db['default']['port']='3306';
$db['default']['database'] = 'cityyellow';
$db['default']['dbdriver'] = 'mysqli';
$db['default']['dbprefix'] = 'yanyu_';
...
$db['external']['password'] = 'root';
$db['external']['port']='3306';
$db['external']['database'] = 'newadmin';
$db['external']['dbdriver'] = 'sqlsrv';//sqlserver
$db['external']['dbprefix'] = 'yanyu_';
